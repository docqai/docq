...
def _handle_error_state_ui(key: str, bubble_error_message: bool = True) -> None:
    ...
    if session_state["_docq_send_ui_error"] is set render the error UI.
    ...
    if (
        ...
        st.error(f"Something went wrong. {msg} {err_str} {trace_id_str}")
...
def set_error_state_for_ui(key: str, error: str, message: str, trace_id: str) -> None:
    ...
    Args:
        ...
        error (str): Typically set to the error return by the exception handler.
        message (str): A user-friendly message to be shown to the user.
        trace_id (str): A unique id that identifies this instance of the error.
    """

...
def list_slack_installations( org_id: int ) -> list[dict[str, Union[str, int]]]:
...
def add_space_group_to_slack_channel( channel_id: str, space_group_id: int ) -> None:
...
def get_slack_channel_space_group_id( channel_id: str ) -> int:

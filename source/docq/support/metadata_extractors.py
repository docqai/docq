...
from llama_index.node_parser.extractors.metadata_extractors import MetadataExtractor, MetadataFeatureExtractor
...
class DocqMetadataExtractor(MetadataExtractor):

...
import docq
from docq.support.store import SpaceType, get_sqlite_global_system_file
...
def add_space_type_to_spaces_table() -> None:
    ...
    with tracer.start_as_current_span("add_space_type_to_spaces_table") as span:
        try:
            ...
            with closing(sqlite3.connect(get_sqlite_global_system_file())) as connection, closing(connection.cursor()) as cursor:
